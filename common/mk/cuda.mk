...
CUDACFLAGS= -gencode arch=compute_60,code=sm_60 $(LANG_CUDACFLAGS) $(PLATFORM_CUDACFLAGS) $(APP_CUDACFLAGS) 
CUDALDFLAGS= -gencode arch=compute_60,code=sm_60 $(LANG_LDFLAGS) $(PLATFORM_CUDALDFLAGS) $(APP_CUDALDFLAGS)
