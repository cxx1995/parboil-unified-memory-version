...
//cudaHostRegister(*phiMag,numK * sizeof(float),cudaHostRegisterDefault);
//cudaMallocManaged(phiMag,numK * sizeof(float));
  *Qr = (float*) memalign(16, numX * sizeof (float));
//cudaHostRegister(*Qr,numX* sizeof(float),cudaHostRegisterDefault);
//cudaMallocManaged(Qr,numK * sizeof(float));
  *Qi = (float*) memalign(16, numX * sizeof (float));
//cudaHostRegister(*Qi,numX* sizeof(float),cudaHostRegisterDefault);
//cudaMallocManaged(Qi,numK * sizeof(float));
}
